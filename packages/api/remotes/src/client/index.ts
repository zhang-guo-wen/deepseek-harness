...
import claudeCompatMcpRemote from '@deepseek-ai/dsh-claude-compat/remote'
...
export type {} from '@deepseek-ai/dsh-claude-compat/remote'
export type {
  AddMcpRequest, DisableMcpRequest, EditMcpRequest, McpMutationResult, McpSpec, McpTarget,
} from '@deepseek-ai/dsh-claude-compat/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      agentPresetsRemote, claudeCompatMcpRemote, commandsRemote, settingsControllerRemote, goalsRemote, llmRemote, dynamicRemote,
