...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AddMcpRequest: 'extensions.md',
  DisableMcpRequest: 'extensions.md',
  EditMcpRequest: 'extensions.md',
  McpMutationResult: 'extensions.md',
  McpSpec: 'extensions.md',
  McpTarget: 'extensions.md',
